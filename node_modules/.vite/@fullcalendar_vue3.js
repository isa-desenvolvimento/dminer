...
} from "./chunk-3YTMFD6M.js";
import {
  __assign,
  __extends
} from "./chunk-QEGZY57M.js";
import {
  __spreadProps,
  __spreadValues
...
var FullCalendar = defineComponent({
  ...
  mounted() {
    ...
    internal.slotOptions = mapHash2(this.$slots, wrapVDomGenerator);
...
function buildOptions(suppliedOptions, appContext) {
  ...
  return __spreadProps(__spreadValues(__spreadValues({}, internal.slotOptions), suppliedOptions), {
...
// dep:@fullcalendar_vue3
var fullcalendar_vue3_default = main_default;
export {
  BASE_OPTION_DEFAULTS,
  BASE_OPTION_REFINERS,
  BaseComponent,
  ...
  createPortal,
  createRef,
  fullcalendar_vue3_default as default,
  diffDates,
  diffDayAndTime,
  diffDays,
  diffPoints,
