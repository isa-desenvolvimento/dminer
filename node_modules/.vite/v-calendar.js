...
import {
  __spreadValues
} from "./chunk-QX3O5XOT.js";

// node_modules/v-calendar/lib/esm/helpers-4f4a4db8.js
...
var some_1 = some;
var getType = (value2) => Object.prototype.toString.call(value2).slice(8, -1);
var isDate$1 = (value2) => isDate_1(value2) && !isNaN(value2.getTime());
var isObject$1 = (value2) => getType(value2) === "Object";
var has$1 = has_1;
...
var pageIsBetweenPages = (page, fromPage2, toPage2) => (page || false) && !pageIsBeforePage(page, fromPage2) && !pageIsAfterPage(page, toPage2);
...
var addPages = ({ month: month2, year: year3 }, count3) => {
...
var on = (element, event, handler2, opts2) => {
  if (element && event && handler2) {
    element.addEventListener(event, handler2, opts2);
  }
};
var off = (element, event, handler2, opts2) => {
  if (element && event) {
...
var onSpaceOrEnter = (event, handler2) => {
...
// node_modules/v-calendar/lib/esm/index-dcbde536.js
...
function isString(value2) {
  return typeof value2 == "string" || !isArray_1(value2) && isObjectLike_1(value2) && _baseGetTag(value2) == stringTag2;
}
  ...
  _createClass(Theme2, [{
    ...
    value: function normalizeHighlight(config) {
      ...
      toPairs_1(highlight).forEach(function(_ref4) {
        var _ref5 = _slicedToArray(_ref4, 2), _ = _ref5[0], targetConfig = _ref5[1];
    ...
    value: function normalizeNonHighlight(type, config, styleFn) {
      ...
      toPairs_1(attr).forEach(function(_ref10) {
        var _ref11 = _slicedToArray(_ref10, 2), _ = _ref11[0], targetConfig = _ref11[1];
...
// node_modules/v-calendar/lib/esm/CalendarDay.vue_vue&type=style&index=0&id=07b52efe&lang-704d2dff.js
...
// node_modules/v-calendar/lib/esm/CalendarPane.vue_vue&type=style&index=0&id=bf16a152&lang-cf3540ec.js
var boolTag2 = "[object Boolean]";
function isBoolean(value2) {
  return value2 === true || value2 === false || isObjectLike_1(value2) && _baseGetTag(value2) == boolTag2;
}
...
var script2 = {
  ...
  render: function render2() {
    ...
    this.page.days.forEach(function(day, i) {
      ...
      dayCells.push(h(script, _objectSpread2(_objectSpread2({}, _this.$attrs), {}, {
        day
      }), _this.$slots));
...
var css_248z3 = ".vc-svg-icon {\n  display: inline-block;\n  stroke: currentColor;\n  stroke-width: 0;\n}\n.vc-svg-icon path {\n    fill: currentColor;\n}\n";
styleInject(css_248z3);
script3.render = render3;
var SvgIcon_default = script3;

// node_modules/v-calendar/lib/esm/CalendarNav-06749734.js
function head(array) {
...
var script4 = {
  ...
  methods: {
    ...
    getYearItems: function getYearItems(yearGroupIndex) {
      var _this3 = this;
      var _this$pageForDate2 = this.pageForDate(new Date()), _ = _this$pageForDate2._, thisYear = _this$pageForDate2.year;
...
// node_modules/v-calendar/lib/esm/Popover.vue_vue&type=style&index=0&id=5059a25e&lang-859ee3d7.js
var script6 = {
  name: "Popover",
  ...
  methods: {
    ...
    setupPopper: function setupPopper() {
      ...
      this.$nextTick(function() {
        ...
        if (!_this5.popper) {
          _this5.popper = createPopper3(_this5.ref, _this5.popoverEl, _this5.popperOptions);
        } else {
...
function render7(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock("div", _hoisted_12, [$options.indicator ? (openBlock(), createBlock("div", _hoisted_22, [createVNode("span", {
    style: $options.indicator.style,
    class: $options.indicator.class
  }, null, 6)])) : createCommentVNode("", true), createVNode("div", _hoisted_32, [renderSlot(_ctx.$slots, "default", {}, function() {
    return [createTextVNode(toDisplayString($props.attribute.popover ? $props.attribute.popover.label : "No content provided"), 1)];
  })])]);
}
var css_248z7 = ".vc-day-popover-row {\n  --day-content-transition-time: 0.13s ease-in;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-align-items: center;\n      -ms-flex-align: center;\n          align-items: center;\n  transition: all var(--day-content-transition-time);\n}\n.vc-day-popover-row:not(:first-child) {\n    margin-top: 3px;\n}\n.vc-day-popover-row-indicator {\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-justify-content: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  -webkit-align-items: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -webkit-flex-grow: 0;\n      -ms-flex-positive: 0;\n          flex-grow: 0;\n  width: 15px;\n  margin-right: 3px;\n}\n.vc-day-popover-row-indicator span {\n    transition: all var(--day-content-transition-time);\n}\n.vc-day-popover-row-content {\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-align-items: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -webkit-flex-wrap: none;\n      -ms-flex-wrap: none;\n          flex-wrap: none;\n  -webkit-flex-grow: 1;\n      -ms-flex-positive: 1;\n          flex-grow: 1;\n  width: -webkit-max-content;\n  width: max-content;\n}\n";
styleInject(css_248z7);
script7.render = render7;
var PopoverRow_default = script7;

// node_modules/v-calendar/lib/esm/Calendar.vue_vue&type=style&index=0&id=0e88c5b9&lang-50d02b25.js
...
var script8 = {
  ...
  render: function render8() {
    ...
    var panes = this.pages.map(function(page, i) {
      ...
      return h(script2, _objectSpread2(_objectSpread2({}, _this.$attrs), {}, {
        key: page.key,
...
var _hoisted_23 = createVNode("div", {
...
function render9(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock("div", _hoisted_13, [createVNode("select", mergeProps(_ctx.$attrs, {
...
var _withId = withScopeId("data-v-63f66eaa");
pushScopeId("data-v-63f66eaa");
var _hoisted_14 = createVNode("div", null, [createVNode("svg", {
  fill: "none",
...
var _hoisted_9 = createVNode("span", {
  style: {
    "margin": "0 4px"
  }
}, ":", -1);
...
popScopeId();
var render10 = _withId(function render11(_ctx, _cache, $props, $setup, $data, $options) {
...
var script11 = {
  ...
  render: function render12() {
    ...
    var calendar = function calendar2() {
      return h(script8, _objectSpread2(_objectSpread2({}, _this.$attrs), {}, {
  ...
  methods: {
    ...
    onDocumentClick: function onDocumentClick2(e) {
...
var setup3 = (app, defaults2) => {
  defaults2 = setup(defaults2);
  app.use(screensPlugin, defaults2.screens);
  return defaults2;
};
var install = (app, defaults2) => {
  defaults2 = setup3(app, defaults2);
  for (const componentKey in components) {
    const component = components[componentKey];
    app.component(`${defaults2.componentPrefix}${component.name}`, component);
  }
};
var esm_default = install;

// dep:v-calendar
var v_calendar_default = esm_default;
export {
  script8 as Calendar,
  script11 as DatePicker,
  script6 as Popover,
  PopoverRow_default as PopoverRow,
  screensPlugin as Screens,
  setup3 as SetupCalendar,
  v_calendar_default as default
};
